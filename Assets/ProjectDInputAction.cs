...
//     version 1.20.0
//     from Assets/ProjectDInputAction.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/ProjectDInputAction.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @ProjectDInputAction: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public @ProjectDInputAction()
    {
        asset = InputActionAsset.FromJson(@"{
    ""version"": 1,
    ""name"": ""ProjectDInputAction"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    ~@ProjectDInputAction()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, ProjectDInputAction.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_Gameplay_keyboard.enabled, "This will cause a leak and performance issues, ProjectDInputAction.Gameplay_keyboard.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, ProjectDInputAction.UI.Disable() has not been called.");
    }
    ...
    {
        private @ProjectDInputAction m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public PlayerActions(@ProjectDInputAction wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct Gameplay_keyboardActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public Gameplay_keyboardActions(@ProjectDInputAction wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Gameplay_keyboard/SelectCharacter".
        /// </summary>
        public InputAction @SelectCharacter => m_Wrapper.m_Gameplay_keyboard_SelectCharacter;
        /// <summary>
        /// Provides access to the underlying input action "Gameplay_keyboard/SelectAction".
        /// </summary>
        public InputAction @SelectAction => m_Wrapper.m_Gameplay_keyboard_SelectAction;
        /// <summary>
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="Gameplay_keyboardActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="Gameplay_keyboardActions" />
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="Gameplay_keyboardActions.UnregisterCallbacks(IGameplay_keyboardActions)" />.
        /// </summary>
        /// <seealso cref="Gameplay_keyboardActions.UnregisterCallbacks(IGameplay_keyboardActions)" />
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="Gameplay_keyboardActions.AddCallbacks(IGameplay_keyboardActions)" />
        /// <seealso cref="Gameplay_keyboardActions.RemoveCallbacks(IGameplay_keyboardActions)" />
        /// <seealso cref="Gameplay_keyboardActions.UnregisterCallbacks(IGameplay_keyboardActions)" />
    ...
    /// <summary>
    /// Provides a new <see cref="Gameplay_keyboardActions" /> instance referencing this action map.
    /// </summary>
    ...
    public struct UIActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public UIActions(@ProjectDInputAction wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "Gameplay_keyboard" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="Gameplay_keyboardActions.AddCallbacks(IGameplay_keyboardActions)" />
    /// <seealso cref="Gameplay_keyboardActions.RemoveCallbacks(IGameplay_keyboardActions)" />
    public interface IGameplay_keyboardActions
    {
        ...
        /// <summary>
        /// Method invoked when associated input action "ActionControl" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
